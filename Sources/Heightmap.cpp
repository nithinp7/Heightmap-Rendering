...
int main()
{
	...
	// -------------------------
	Shader skyboxShader("../Heightmap/Shaders/skybox.vert", "../Heightmap/Shaders/skybox.frag");
	Shader renderShader("../Heightmap/Shaders/render.vert", "../Heightmap/Shaders/render.frag");
	Shader lineShader("../Heightmap/Shaders/line.vert", "../Heightmap/Shaders/line.frag");
	...
	// init heatmap
	unsigned int pre_texture = loadTexture("../Heightmap/Media/textures/pre.png");
	unsigned int post_texture = loadTexture("../Heightmap/Media/textures/post.png");
	...
	Render render = Render(renderShader, lineShader);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		set_lighting(renderShader, pointLightPositions);
		...
		render.Draw(renderShader, lineShader, pre_texture, post_texture, renderPre);
...
void print_screen()
{
	string path = "../Heightmap/Animation/out-";
	if (printID < 100)
		path += "0";
	if (printID < 10)
		path += "0";
